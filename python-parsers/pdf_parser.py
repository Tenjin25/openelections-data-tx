...
def process_text_file(text_path):
    ...
    try:
        ...
        replacements = [
            ...
            (r'President and Vice President', 'President'), # Replace U.S. Representative
        ...
        filter_patterns = [
            ...
            r'^ELECTION RESULTS	 GENERAL ELECTION$',
            r'^ELECTION RESULTS	GENERAL ELECTION$',
            r'^November 5, 2024.*$',
            r'^Statistics.*$',
            r'^STATISTICS.*$',
            r'^Vote For.*$',
            r'^Precinct Results Report	Official Results$',
            r'^Precinct Results Report	 Official Results$',
            r'^Precinct Summary.*$',
            ...
            r'^- 12/09/2024.*$',
            r'^11/5/2024$',
            r'^Run Time.*$',  # Matches "Run Time: HH:MM:SS",
            r'^Run Date.*$',  # Matches "Run Date: YYYY-MM-DD",
            r'^Choice	Party.*$',  # Matches "Choice Party: [Party Name]"
            r'^BURLESON COUNTY, TEXAS$',
